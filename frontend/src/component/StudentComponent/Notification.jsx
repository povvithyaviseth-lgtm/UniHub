...
export default function Notification() {
  ...
  const [notifications, setNotifications] = React.useState([
    {
      id: "1",
      title: "Robotics Workshop: Begin Building Helper Robots",
      clubName: "The Robotics Team",
      dateTime: "Sat, Oct 1 | 5:00 PM - 9:30 AM",
      location: "Location: University Union, Redwood room",
      checked: false,
    },
    {
      id: "2",
